		...
		<AlertDialog
			...
			<AlertDialogContent>
				<AlertDialogHeader>
					...
					<AlertDialogTitle>{activeDialog?.kind === 'confirm-dialog' ? activeDialog.title : '确认操作'}</AlertDialogTitle>
					<AlertDialogDescription>
				...
				<AlertDialogFooter>
					<div className='flex w-full flex-col-reverse gap-2 sm:flex-row sm:items-center sm:justify-between'>
						<AlertDialogCancel>{activeDialog?.kind === 'confirm-dialog' ? activeDialog.cancelLabel ?? '取消' : '取消'}</AlertDialogCancel>
