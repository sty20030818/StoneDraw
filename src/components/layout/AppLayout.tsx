...
import { BadgeCheckIcon, CommandIcon, DatabaseZapIcon, FolderOpenIcon, TerminalSquareIcon } from 'lucide-react'
				...
				<header className='flex flex-col gap-4 rounded-xl border border-border/70 bg-card/80 px-5 py-4 shadow-sm backdrop-blur md:flex-row md:items-center md:justify-between'>
					<div className='flex flex-col gap-2'>
						...
						<div className='flex flex-col gap-1'>
							<h1 className='text-xl font-semibold tracking-tight'>接入 SQLite 与 migration 机制</h1>
