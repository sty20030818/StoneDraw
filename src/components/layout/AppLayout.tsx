...
import { BadgeCheckIcon, CommandIcon, TerminalSquareIcon } from 'lucide-react'
	...
	return (
		<div className='min-h-screen px-3 py-3 md:px-4 md:py-4'>
			<div className='mx-auto flex min-h-[calc(100vh-1.5rem)] max-w-[1600px] flex-col gap-3'>
				<header className='flex flex-col gap-4 rounded-[2rem] border border-border/70 bg-card/80 px-5 py-4 shadow-sm backdrop-blur md:flex-row md:items-center md:justify-between'>
					<div className='flex flex-col gap-2'>
						...
						<div className='flex flex-col gap-1'>
							<h1 className='text-xl font-semibold tracking-tight'>应用布局、路由与基础 UI 外壳</h1>
